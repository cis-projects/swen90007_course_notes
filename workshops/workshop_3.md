...
> Note that the Docker image we are using is the official PostgreSQL supported image, you can learn more about this image and its usage [here](https://hub.docker.com/_/postgres/)
