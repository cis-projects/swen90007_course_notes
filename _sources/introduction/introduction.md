...
Welcome to the course notes for [**SWEN90007 Software Design and Architecture**](https://handbook.unimelb.edu.au/subjects/swen90007) at the University of Melbourne.
...
:::{grid-item-card} JSP Project Setup
:link: /setup_dev/introduction
:link-type: doc
:class-card: sd-shadow-sm sd-rounded-3
...
:::{grid-item-card} React Project Setup
:link: /react-example/swen90007-react-example-primer
:link-type: doc
:class-card: sd-shadow-sm sd-rounded-3
...
- **New to the subject?** Start with [Workshop 1](/workshops/workshop_1) for the subject and project overview, the assessment breakdown, and the semester timeline — then follow the setup guide for your team's chosen front-end (JSP or React).
...
![Raising a GitHub issue from the top-right menu](resources/github_issue.png)
```
