...
![[connect-postgres-server-docker.png]]
...
![[postgres-render-connections.png]]
...
![[connect-postgres-server-render.png]]
...
![[postgres-database-connected.png]]
...
![[configure-web-service-render.png]]
...
![[configure-render-static-site.png]]
...
![[configure-render-static-site-env.png]]

Leave the rest of the Advanced configuration as is and select *Create Static Site*. Once the UI has been built and deployed it should be available at `https://<your-static-sites-hostname>`. 

![[static-site-active.png]]

We're not quite done though, if you visit the UI and attempt fetch data from the API you'll encounter a familiar error.

![[error-static-site.png]]
...
![[fix-cors-web-service-configuration.png]]
